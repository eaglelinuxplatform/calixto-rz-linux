...
#define THREAD_CPU_CONTEXT 2384 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_KEYS_USER 3352 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3432 /* offsetof(struct task_struct, thread.keys_kernel) */
